 ...
 */
export const getApiV1Brands = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1BrandsData, ThrowOnError>) => (options?.client ?? client).get<GetApiV1BrandsResponses, GetApiV1BrandsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/brands',
    ...options
});
 ...
 */
export const getApiV1MetaAppVersion = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1MetaAppVersionData, ThrowOnError>) => (options?.client ?? client).get<GetApiV1MetaAppVersionResponses, GetApiV1MetaAppVersionErrors, ThrowOnError>({
    security: [{ name: 'x-api-key', type: 'apiKey' }],
 ...
 */
export const postApiV1CardsByIdView = <ThrowOnError extends boolean = false>(options: Options<PostApiV1CardsByIdViewData, ThrowOnError>) => (options.client ?? client).post<PostApiV1CardsByIdViewResponses, PostApiV1CardsByIdViewErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
